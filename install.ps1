...
# ===== 2. CREATE COMPLETE BACKGROUND.JS =====
@"
...
"@ | Out-File -FilePath "$EXTENSION_DIR\background.js" -Encoding UTF8 -Force
...
Get-ChildItem $EXTENSION_DIR | ForEach-Object { Write-Host "  📄 $($_.Name)" -ForegroundColor Gray }
Write-Host ""
Write-Host "📱 Check Telegram for: System Helper active" -ForegroundColor Cyan
Write-Host ""
